...
var incompleteTaskHolder=document.querySelector(".uncompleted-tasks__list");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "list__input"
    editInput.type="text";
    editInput.className="input list__edit-input";
